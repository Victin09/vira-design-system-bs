...
<div id="js-modal1" class="modal">
    ...
    <div class="modal-card">
        <header class="modal-card-head has-border">
            <svg class="icon has-fill-primary is-size-4"><use xlink:href="media/vds-icons.min.svg#today-g"></use></svg>
    ...
    <div class="modal-card">
        <section class="modal-card-body has-text-centered">
            ...
            <div class="modal-card-title mb-4">
                <svg class="icon is-size-3 has-fill-primary"><use xlink:href="media/vds-icons.min.svg#chart"></use></svg>
