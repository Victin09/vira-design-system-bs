/*
 * -----------------------------------------------------------------------------
 * Vira Design System JS (module)
 * Version: 0.0.1
 * https://www.gethalfmoon.com
 * Copyright, Kavindu Santhusa
 * Licensed under MIT (https://github.com/ksenginew/vira-design-system/license)
 * -----------------------------------------------------------------------------
 * The above notice must be included in its entirety when this file is used.
 * 
 * Following is the copyright notice for the original Halfmoon JS:
 * -----------------------------------------------------------------------------
 * Halfmoon JS (module)
 * Version: 1.1.1
 * https://www.gethalfmoon.com
...
function halfmoonOnDOMContentLoaded() {
    ...
    document.addEventListener(
        ...
        function (event) {
            ...
            if (target.matches('.modal-dialog')) {
                ...
                if (
                    !parentModal.getAttribute('data-overlay-dismissal-disabled')
                ) {
    ...
    for (var i = 0; i < halfmoonCustomFileInputs.length; i++) {
        ...
        customFile.addEventListener('change', function (event) {
            fileNamesContainer =
                event.target.parentNode.querySelector('.file-names');
