...
layout: docs
title: Scrollspy
description: Automatically update Vira Design System navigation or list group components based on scroll position to indicate which link is currently active in the viewport.
group: components
toc: true
---
...
- It must be used on a Vira Design System [nav component]({{< docsref "/components/navs-tabs" >}}) or [list group]({{< docsref "/components/list-group" >}}).
...
```js
var scrollSpy = new viraDesignSystem.ScrollSpy(document.body, {
