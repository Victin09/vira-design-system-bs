/*! ViraDesignSystem 3.13.5 | https://www.getvds.com | (c) 2014 - 2022 YOOtheme | MIT License */

(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
    typeof define === 'function' && define.amd ? define('viradesignsystem', factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.ViraDesignSystem = factory());
    ...
    function getCssVar(name, element) {if (element === void 0) {element = document.documentElement;}
      return css(element, "--vds-" + name).replace(propertyRe, '$2');
    }
    ...
    function transition(element, props, duration, timing) {if (duration === void 0) {duration = 400;}if (timing === void 0) {timing = 'linear';}
      ...
      new Promise((resolve, reject) => {
        ...
        (_ref) => {let { type } = _ref;
          clearTimeout(timer);
          removeClass(element, 'vds-transition');
          css(element, {
            transitionProperty: '',
            transitionDuration: '',
        ...
        addClass(element, 'vds-transition');
        css(element, {
    ...
    const Transition = {
      ...
      inProgress(element) {
        return hasClass(element, 'vds-transition');
      } };


    const animationPrefix = 'vds-animation-';
    ...
    function animate$1(element, animation, duration, origin, out) {if (duration === void 0) {duration = 200;}
      ...
      new Promise((resolve, reject) => {
        ...
        if (startsWith(animation, animationPrefix)) {
          origin && addClass(element, "vds-transform-origin-" + origin);
    ...
    */
    ...
    function globalAPI (ViraDesignSystem) {
    ...
    function hooksAPI (ViraDesignSystem) {
      ViraDesignSystem.prototype._callHook = function (hook) {var _this$$options$hook;
        (_this$$options$hook = this.$options[hook]) == null ? void 0 : _this$$options$hook.forEach((handler) => handler.call(this));
      };

      ViraDesignSystem.prototype._callConnected = function () {
        if (this._connected) {
          return;
        }
      ...
      ViraDesignSystem.prototype._callDisconnected = function () {
        if (!this._connected) {
          return;
        }
      ...
      ViraDesignSystem.prototype._callUpdate = function (e) {if (e === void 0) {e = 'update';}
        if (!this._connected) {
          return;
        }
      ...
      ViraDesignSystem.prototype._callWatches = function () {
        if (this._watch) {
          return;
        }
    ...
    function stateAPI (ViraDesignSystem) {
      let uid = 0;
    ...
    function instanceAPI (ViraDesignSystem) {
      const DATA = ViraDesignSystem.data;
      ...
      ViraDesignSystem.prototype.$destroy = function (removeEl) {if (removeEl === void 0) {removeEl = false;}
      ...
      ViraDesignSystem.prototype.$update = function (element, e) {if (element === void 0) {element = this.$el;}
    ...
    function componentAPI (ViraDesignSystem) {
      const DATA = ViraDesignSystem.data;
      ...
      ViraDesignSystem.component = function (name, options) {
        ...
        opt.install == null ? void 0 : opt.install(ViraDesignSystem, opt, name);
      ...
      ViraDesignSystem.getComponents = (element) => (element == null ? void 0 : element[DATA]) || {};
    ...
    ViraDesignSystem.version = '3.13.5';
    ...
    function Core () {
      ...
      (_ref) => {let { target } = _ref;
        if ((css(target, 'animationName') || '').match(/^vds-.*(left|right)/)) {
          started++;
    ...
    function boot (ViraDesignSystem) {
      ...
      function applyAttributeMutation(_ref2) {var _ViraDesignSystem$get;let { target, attributeName } = _ref2;
        ...
        (_ViraDesignSystem$get = ViraDesignSystem.getComponent(target, name)) == null ? void 0 : _ViraDesignSystem$get.$destroy();
      }
    }
    ...
    var Togglable = {
      ...
      data: {
        ...
        origin: false,
        transition: 'linear',
        clsEnter: 'vds-togglabe-enter',
        clsLeave: 'vds-togglabe-leave',
    ...
    var Accordion = {
      ...
      data: {
        ...
        multiple: false,
        clsOpen: 'vds-open',
        toggle: '> .vds-accordion-title',
        content: '> .vds-accordion-content',
        transition: 'ease',
        offset: 0 },
    ...
    var drop = {
      ...
      connected() {
        this.clsDrop = this.$props.clsDrop || "vds-" + this.$options.name;
    ...
    var Margin = {
      ...
      data: {
        margin: 'vds-margin-small-top',
        firstColumn: 'vds-first-column' },
    ...
    var grid = {
      ...
      data: {
        margin: 'vds-grid-margin',
        clsStack: 'vds-grid-stack',
        masonry: false,
        parallax: 0 },


      connected() {
        this.masonry && addClass(this.$el, 'vds-flex-top vds-flex-wrap-top');
      },
    ...
    function applyAnimation(el) {
      ...
      if (length) {
        el.style.setProperty('--vds-animation-stroke', length);
      }
    }
    ...
    const parsed = {};
    function install$3(ViraDesignSystem) {
    ...
    var leader = {
      ...
      data: {
        fill: '',
        clsWrapper: 'vds-leader-fill',
        clsHide: 'vds-leader-hide',
        attrFill: 'data-fill' },
    ...
    function install$2(_ref) {let { modal } = _ref;
      modal.dialog = function (content, options) {
        const dialog = modal("<div class=\"vds-modal\"> <div class=\"vds-modal-dialog\">" +
      ...
      modal.alert = function (message, options) {
        return openDialog(
        (_ref2) => {let { labels } = _ref2;return "<div class=\"vds-modal-body\">" + (
          isString(message) ? message : html(message)) + "</div> <div class=\"vds-modal-footer vds-text-right\"> <button class=\"vds-button vds-button-primary vds-modal-close\" autofocus>" +
      ...
      modal.confirm = function (message, options) {
        return openDialog(
        (_ref3) => {let { labels } = _ref3;return "<form> <div class=\"vds-modal-body\">" + (
          isString(message) ? message : html(message)) + "</div> <div class=\"vds-modal-footer vds-text-right\"> <button class=\"vds-button vds-button-default vds-modal-close\" type=\"button\">" +


          labels.cancel + "</button> <button class=\"vds-button vds-button-primary\" autofocus>" +
      ...
      modal.prompt = function (message, value, options) {
        return openDialog(
        (_ref4) => {let { labels } = _ref4;return "<form class=\"vds-form-stacked\"> <div class=\"vds-modal-body\"> <label>" + (

          isString(message) ? message : html(message)) + "</label> <input class=\"vds-input\" value=\"" + (
          value || '') + "\" autofocus> </div> <div class=\"vds-modal-footer vds-text-right\"> <button class=\"vds-button vds-button-default vds-modal-close\" type=\"button\">" +



          labels.cancel + "</button> <button class=\"vds-button vds-button-primary\">" +
    ...
    const navItem = '.vds-navbar-nav > li > a, .vds-navbar-item, .vds-navbar-toggle';
      ...
      computed: {
        ...
        dropbar: {
          get(_ref4) {let { dropbar } = _ref4;
            ...
            $('+ .vds-navbar-dropbar', this.$el);

            return dropbar ? dropbar : this._dropbar = $('<div></div>');
          },

          watch(dropbar) {
            addClass(dropbar, 'vds-navbar-dropbar');
          },
    ...
    var offcanvas = {
      ...
      data: {
        ...
        flip: false,
        overlay: false,
        clsPage: 'vds-offcanvas-page',
        clsContainer: 'vds-offcanvas-container',
        selPanel: '.vds-offcanvas-bar',
        clsFlip: 'vds-offcanvas-flip',
        clsContainerAnimation: 'vds-offcanvas-container-animation',
        clsSidebarAnimation: 'vds-offcanvas-bar-animation',
        clsMode: 'vds-offcanvas',
        clsOverlay: 'vds-offcanvas-overlay',
        selClose: '.vds-offcanvas-close',
        container: false },
    ...
    var overflowAuto = {
      ...
      data: {
        selContainer: '.vds-modal',
        selContent: '.vds-modal-dialog',
        minHeight: 150 },
    ...
    var responsive = {
      ...
      connected() {
        addClass(this.$el, 'vds-responsive-width');
      },
    ...
    var scrollspy = {
      ...
      data: () => ({
        ...
        repeat: false,
        delay: 0,
        inViewClass: 'vds-scrollspy-inview' }),
      ...
      update: [
      {
        read() {
          for (const el of this.elements) {
            if (!el[stateKey]) {
              el[stateKey] = { cls: data(el, 'vds-scrollspy-class') || this.cls };
            }
      ...
      methods: {
        toggle(el, inview) {
          ...
          if (/\bvds-animation-/.test(state.cls)) {
            const removeAnimationClasses = () => removeClasses(el, 'vds-animation-[\\w-]+');
            if (inview) {
    ...
    var sticky = {
      ...
      data: {
        ...
        offset: 0,
        animation: '',
        clsActive: 'vds-active',
        clsInactive: '',
        clsFixed: 'vds-sticky-fixed',
        clsBelow: 'vds-sticky-below',
        selTarget: '',
        showOnUp: false,
        targetOffset: false },
      ...
      connected() {
        this.placeholder =
        $('+ .vds-sticky-placeholder', this.$el) ||
        $('<div class="vds-sticky-placeholder"></div>');
        this.isFixed = false;
    ...
    var Switcher = {
      ...
      data: {
        connect: '~.vds-switcher',
        toggle: '> * > :first-child',
        itemNav: false,
        active: 0,
        cls: 'vds-active',
        attrItem: 'vds-switcher-item' },
      ...
      computed: {
        ...
        toggles: {
          get(_ref2, $el) {let { toggle } = _ref2;
            ...
            (el) => !matches(el, '.vds-disabled *, .vds-disabled, [disabled]'));
    ...
    // register components
    each(components$1, (component, name) => ViraDesignSystem.component(name, component));
    ...
    const clsLeave = 'vds-transition-leave';
    const clsEnter = 'vds-transition-enter';
    ...
    function fade(action, target, duration, stagger) {if (stagger === void 0) {stagger = 0;}
      ...
      const enterFn = wrapIndexFn(() => {
        ...
        // Ensure ViraDesignSystem updates have propagated
        return new Promise((resolve) =>
    ...
    var Slideshow = {
      ...
      data: {
        animation: 'slide',
        clsActivated: 'vds-transition-active',
    ...
    var LightboxPanel = {
      ...
      data: () => ({
        ...
        template: "<div class=\"vds-lightbox vds-overflow-hidden\"> <ul class=\"vds-lightbox-items\"></ul> <div class=\"vds-lightbox-toolbar vds-position-top vds-text-right vds-transition-slide-top vds-transition-opaque\"> <button class=\"vds-lightbox-toolbar-icon vds-close-large\" type=\"button\" vds-close></button> </div> <a class=\"vds-lightbox-button vds-position-center-left vds-position-medium vds-transition-fade\" href vds-slidenav-previous vds-lightbox-item=\"previous\"></a> <a class=\"vds-lightbox-button vds-position-center-right vds-position-medium vds-transition-fade\" href vds-slidenav-next vds-lightbox-item=\"next\"></a> <div class=\"vds-lightbox-toolbar vds-lightbox-caption vds-position-bottom vds-text-center vds-transition-slide-bottom vds-transition-opaque\"></div> </div>" }),
    ...
    var lightbox = {
      ...
      events: [
      {
        ...
        delegate() {
          return this.toggle + ":not(.vds-disabled)";
        },
    ...
    function install$1(ViraDesignSystem, Lightbox) {
      if (!ViraDesignSystem.lightboxPanel) {
        ViraDesignSystem.component('lightboxPanel', LightboxPanel);
      }

      assign(Lightbox.props, ViraDesignSystem.component('lightboxPanel').options.props);
    }
    ...
    var notification = {
      ...
      data: {
        ...
        group: null,
        pos: 'top-center',
        clsContainer: 'vds-notification',
        clsClose: 'vds-notification-close',
        clsMsg: 'vds-notification-message' },
      ...
      created() {
        ...
        this.clsClose + "\" data-vds-close></a> <div>" +
    ...
    function install(ViraDesignSystem) {
      ViraDesignSystem.notification.closeAll = function (group, immediate) {
        apply(document.body, (el) => {
          const notification = ViraDesignSystem.getComponent(el, 'notification');
    ...
    var slider = {
      ...
      data: {
        center: false,
        sets: false,
        attrItem: 'vds-slider-item',
        selList: '.vds-slider-items',
        selNav: '.vds-slider-nav',
        clsContainer: 'vds-slider-container',
        Transitioner },
    ...
    var slideshow = {
      ...
      data: {
        ...
        minHeight: false,
        maxHeight: false,
        selList: '.vds-slideshow-items',
        attrItem: 'vds-slideshow-item',
        selNav: '.vds-slideshow-nav',
        Animations },
    ...
    var sortable = {
      ...
      data: {
        group: false,
        threshold: 5,
        clsItem: 'vds-sortable-item',
        clsPlaceholder: 'vds-sortable-placeholder',
        clsDrag: 'vds-sortable-drag',
        clsDragState: 'vds-drag',
        clsBase: 'vds-sortable',
        clsNoDrag: 'vds-sortable-nodrag',
        clsEmpty: 'vds-sortable-empty',
        clsCustom: '',
        handle: false,
        pos: {} },
    ...
    var tooltip = {
      ...
      data: {
        ...
        title: '',
        delay: 0,
        animation: ['vds-animation-scale-up'],
        duration: 100,
        cls: 'vds-active' },
      ...
      methods: {
        ...
        _show() {
          this.tooltip = append(
          this.container, "<div class=\"vds-" +
          this.$options.name + "\"> <div class=\"vds-" +
