...
export default class VdsSpin extends VdsEl {
  static get vdsTag() {
    return 'vds-spin';
  }
  ...
  static vdsCSS({ tag, css }) {
    return [
      ...
      `${tag} {
        animation: vds-spin-animation calc(var(--spin-animation-time) * var(--transition-enabler)) linear infinite;
      }`,
