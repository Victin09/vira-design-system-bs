            ...
            <span>
                <section className="padtop" id="inputs">
                    <div className="content">
                        ...
                        <p>Vira Design System inputs come with styling for all sorts of input types.</p>
                                ...
                                <div className="col-6">
                                    <div className="input-control">
                                        <select className="select" placeholder="Select One">
                                            <option value="I love this">I love Vira Design System</option>
                                            <option value="I still love this">I also love Vira Design System</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="row">
                            <div className="col-lg-6">
                                ...
                                <div className="row level">
                                    ...
                                    <div className="col-xs-9 level-item">
                                        <input type="email" value="john.doe@vds.io" />
                                    </div>
                                </div>
                                <div className="row level">
                                    <div className="col-xs-3 level-item">
                                    ...
                                    <div className="col-xs-9 level-item">
                                        <input type="url" value="https://spiderpig86.github.io/Vira Design System" />
                                    </div>
                                </div>
                                <div className="row level">
                                    <div className="col-xs-3 level-item">
...
<div class="row level">
    ...
    <div class="col-xs-9 level-item"><input type="email" value="john.doe@vds.io"></div>
</div>
<!-- Url -->
<div class="row level">
    <div class="col-xs-3 level-item">
    ...
    <div class="col-xs-9 level-item"><input type="url" value="https://spiderpig86.github.io/Vira Design System"></div>
</div>
<!-- Search -->
<div class="row level">
    <div class="col-xs-3 level-item">
...
<div class="input-control">
        ...
        <option value="1">Error/Danger state</option>
                ...
                <section className="padtop" id="label">
                    <div className="content">
                        ...
                        <p>
                            Labels are quite basic within Vira Design System's forms. An additional <code>info</code> class exists
    ...
    <span class="info u-text-center">I am using the <code>info</code> class.</span>
                        ...
                        <div className="row">
                            <div className="col-lg-6">
                                <label>Email</label>
                                <input type="text" placeholder="john.doe@vds.io" />
