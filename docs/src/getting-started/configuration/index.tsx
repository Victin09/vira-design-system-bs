            ...
            <div>
                <section id="configuration" className="padtop">
                    <div className="content">
                        ...
                        />
                        <p>
                            Almost every aspect of Vira Design System can be customized. You can modify existing component styles,
                ...
                <section className="padtop" id="schema">
                    <div className="content">
                        ...
                        <p>
                            Before we get started on how to use Vira Design System with configuration, let's talk about what the
                                ...
                                <ul className="no-bullets">
                                    ...
                                    <li>
                                        <details open>
                                            ...
                                            <p>Extend collection of generated classes within Vira Design System.</p>
                                        </details>
                                    </li>
                                    <li>
                                        <details open>
            ...
            opacity: (
                ...
                75: .75,
                        ...
                        <p>
                            ...
                            <ExternalLink url="https://github.com/Victin09/vira-design-system/tree/master/src/internal">
                                internal
                            </ExternalLink>{' '}
...
// Example use of Vira Design System internal APIs
@screen-above($md) {
    .my-class {
...
...`}
                        ...
                        <p>
                            ...
                            <ExternalLink url="https://github.com/Victin09/vira-design-system/blob/47b672b9f406cba27ca38fa00add9c3c0910206e/src/internal/_config.scss#L34">
                                here
                            </ExternalLink>
                            .
                        </p>
        ...
        extend: (
            semantic: (
                ...
                'midnight': '#121062',
                        ...
                        <p>Vira Design System will then generate the following classes.</p>
                        <CodeBlock
...
...`}
                        ...
                        <p>
                            ...
                            <ExternalLink url="https://github.com/Victin09/vira-design-system/blob/47b672b9f406cba27ca38fa00add9c3c0910206e/src/internal/_config.scss#L59">
                                here
                            </ExternalLink>
                            .
                        </p>
                ...
                <section className="padtop" id="clearing-defaults">
                    <div className="content">
                        ...
                        <p>
                            To clear defaults defined in Vira Design System's default configuration, all we need to do is set the
...
...`}
                ...
                <section className="padtop" id="excludes">
                    <div className="content">
                        ...
                        <div className="divider"></div>
                        <p>
                            The <code>excludes</code> field is used to <b>disable features in Vira Design System</b>. For instance,
                            if I add <code>'AVATAR'</code> in this list, then Vira Design System will skip generating all classes
        ...
        excludes: (
            'AVATAR'
                        ...
                        <p>
                            ...
                            <ExternalLink url="https://github.com/Victin09/vira-design-system/tree/master/src/base">
                                base
                            </ExternalLink>{' '}
                            folder.
                        </p>
        ...
        excludes: (
            'ALL'
                        ...
                        <p>
                            ...
                            <ExternalLink url="https://github.com/Victin09/vira-design-system/blob/51eaa19fe9f38acb3f91e69ae55dc90cf8135e8d/src/internal/_flags.scss">
                                here
                            </ExternalLink>
                            .
                        </p>
                ...
                <section className="padtop" id="includes">
                    <div className="content">
                        ...
                        <div className="divider"></div>
                        <p>
                            The <code>includes</code> field is used to <b>enable features in Vira Design System</b>. This can happen
                            if you were extending from a custom configured version of Vira Design System that disabled some things
                            you wanted to have. For instance, if I add <code>'AVATAR'</code> in this list, then Vira Design System
                            will generate all classes associated with the Avatar component.
                        </p>
                        <CodeBlock
                            code={`@use "vds-with-avatar-off" as * with (
    $config: (
        includes: (
            'AVATAR'
        )
                        ...
                        <p>
                            ...
                            <code>includes</code> field is applied after Vira Design System process <code>excludes</code>.
                        </p>
                        <CodeBlock
                            code={`@use "node_modules/vds-ui/src/vds-ext" as * with (
    $config: (
        ...
        includes: (
            'AVATAR' // Only enable AVATAR component
                        ...
                        <CodeBlock
                            code={`@use "vds-with-some-features-off" as * with (
    $config: (
        includes: (
            'ALL'
        )
