            ...
            <div>
                ...
                <section className="padtop" id="base">
                    <div className="content">
                        ...
                        <p>
                            The foundation of any page styled with Vira Design System starts with its base styles. The base styles
                            of Vira Design System consist of:
                        </p>
                        <ul>
                            <li>
                        ...
                        <p>
                            ...
                            foundation for Vira Design System components.
                        </p>
...
...`}
                        ...
                        />
                        <p>
                            The <code>content</code> class is one of the most essential classes used in Vira Design System to add
...
...`}
                ...
                <section className="padtop" id="wrapping-up">
                    <div className="content">
                        ...
                        <p>I hope that guide was a useful introduction to developing your project with Vira Design System. The portfolio here is by no means a finished product. There are many other things you can add such as more pages, a working dropdown hamburger menu, a working form, etc.</p>
