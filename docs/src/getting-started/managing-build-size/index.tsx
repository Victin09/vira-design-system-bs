            ...
            <div>
                <section id="managing-build-size" className="padtop">
                    <div className="content">
                        ...
                        />
                        <p>
                            Since Vira Design System is built with customization in mind, it makes sense for the framework to allow
                            features to be enabled, disabled, or modified. One of the pain point for some CSS frameworks
                            is its size. Vira Design System by no means is a hefty CSS framework, but reduction in file size would
                ...
                <section className="padtop" id="file-size">
                    <div className="content">
                        ...
                        <div className="divider"></div>
                        <p>As of now, the different builds of Vira Design System clock in at the following sizes:</p>
                        <BuildSizeTable />

                        <p>
                            Vira Design System comes in 3 preset builds that cover the requirements of most users to balance the
                        ...
                        <p>
                            ...
                            of ways to customize your build of Vira Design System through the config file. The docs below goes over
                            all the ways you can manage your file size when building Vira Design System for your project.
                        </p>
                ...
                <section className="padtop" id="purge-css">
                    <div className="content">
                        ...
                        <p>
                            ...
                            third-party tools like <b>PurgeCSS</b> to tree-shake unused Vira Design System styles in your project.
                        ...
                        <p>
                            To find out how to integrate this into Vira Design System and your project, check out the{' '}
                ...
                <section className="padtop" id="disabling-features">
                    <div className="content">
                        ...
                        <p>
                            This is perhaps one of the quickest ways to reduce your Vira Design System build size. Vira Design System comes with
                        ...
                        <p>
                            In your project, import the Vira Design System library and specify the enabled and disabled features
        ...
        excludes: (
            ...
            'POSITION',
                        ...
                        <p>
                            ...
                            <ExternalLink url="https://github.com/Victin09/vira-design-system/tree/master/src">
                                repository
                            </ExternalLink>{' '}
                ...
                <section className="padtop" id="disabling-viewport-variants">
                    <div className="content">
                        ...
                        <p>
                            In your project, import the Vira Design System library and specify the enabled and disabled viewports
                            similar to what's shown below:
                        </p>
    ...
    $config: (
        viewports: (
            ...
            FLEX: false,
                        ...
                        <p>
                            All supported viewport flags can be found in the <code>vds-all</code> build configuration{' '}
                            <ExternalLink url="https://github.com/Victin09/vira-design-system/blob/master/src/vds-all.scss#L4">
                                here
                            </ExternalLink>
                            .
                        </p>
            ...
            'indigo': null,
                ...
                <section className="padtop" id="limiting-viewports">
                    <div className="content">
                        ...
                        <p>
                            In your project, import the Vira Design System library and disable viewports by setting the existing viewport widths and pairs to null and specifying the ones you want in the extend section:
                        </p>
            ...
            breakpoints: (
                widths: (
                    ...
                    'laptops': '1024px',
                        ...
                        <p>Below is how reducing the number of breakpoints would affect the build size. By default Vira Design System comes with 4 breakpoints specified.</p>
                        <table className="table bordered">
                            <tr>
