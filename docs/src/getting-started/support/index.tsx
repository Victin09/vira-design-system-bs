            ...
            <div>
                <section id="support" className="padtop">
                    <div className="content">
                        ...
                        <p>
                            As of this latest release, Vira Design System has launched many new features that may not be compatible
                            with all browsers, especially older ones.
                        </p>
                        <p>
                            For instance, Vira Design System no longer uses <b>vendor prefixes</b> in styles that are known to have
                            some compatibility issues except for a few parts. Vira Design System also supports new features such as{' '}
                            <b>CSS grid</b>, <b>object fit</b>, and <b>sticky positioning</b> which is not yet supported
                            on all browsers.
                        </p>

                        <p>
                            In short, Vira Design System supports all the latest supported browsers with <b>only</b> partial support
