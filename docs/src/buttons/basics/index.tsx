            ...
            <div>
                <section className="padtop" id="buttons">
                    <div className="content">
                        ...
                        <p>
                            Buttons in Vira Design System come with some basic styling to help you get started. You can choose some
...
<input type="submit" value="Submit">`}
                ...
                <section className="padtop" id="colors">
                    <div className="content">
                        ...
                        <div className="divider"></div>
                        <p>
                            Vira Design System comes in quite a few different shades of colors. Below are some of the preset styles
