            ...
            <div>
                <section id="introduction" className="padtop">
                    <div className="content">
                        ...
                        <p className="lead">Hit the ground running with Vira Design System at your own pace.</p>
                        ...
                        <div className="grid grid-cols-1 u-gap-1 grid-cols-3-xl">
                            ...
                            >
                                ...
                                <p className="text-white u-color-opacity-80">
                                    Learn how to get started with Vira Design System one step at a time.
                                </p>
                                <img
                ...
                <section id="what" className="padtop">
                    <div className="content">
                        <Headline title="What is Vira Design System?" link="#what" size="3" />
                        <div className="divider"></div>

                        <p>
                            Introducing <b>Vira Design System</b>, a modular, responsive, and component centric SCSS framework aimed
                        ...
                        <div className="u-inline-flex u-flex-wrap u-gap-1">
                            <img
                                src={`https://img.shields.io/badge/vds-${VERSION}-blue.svg?style=flat-square`}
                                alt="Version"
                            />
                            <img
                                src="https://img.shields.io/github/license/Spiderpig86/Vira Design System.svg?style=flat-square"
                                alt="MIT License"
                            />
                            <img
                                src="https://img.shields.io/npm/dm/vds-ui.svg?style=flat-square"
                                alt="NPM Downloads"
                            />
                            <img
                                src="https://data.jsdelivr.com/v1/package/npm/vds-ui/badge"
                ...
                <section id="why" className="padtop">
                    <div className="content">
                        <Headline title="Why Vira Design System?" link="#lightweight" size="3" />
                        <div className="divider"></div>
                        <p>
                            Here are a couple of reasons why <b>you should</b> consider Vira Design System for your next project.
                        </p>
                        ...
                        <section id="prototype" className="">
                            ...
                            <div className="divider"></div>
                            <p>
                                Vira Design System was built to remove all the overhead associated with designing any app. The
    ...
    <div class="frame__footer"></div>
                        ...
                        <section id="utilities" className="padtop">
                            ...
                            <p>
                                ...
                                your design. Vira Design System comes with a variety of utility classes to make your idea a reality.
                            </p>
    ...
    <div>
      <img class="h-100p img-cover" src="https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?ixlib=rb-1.2.1&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=200&amp;q=80">
                        ...
                        <section id="lightweight" className="padtop">
                            ...
                            <div className="divider"></div>
                            <p>
                                Vira Design System comes with lots of functionality in a small package which only consists of a
                        ...
                        <section id="sass" className="padtop">
                            ...
                            <p>
                                Vira Design System is written in Sass, meaning you can leverage the power of Sass right inside your
                                project out of the box. Importing Vira Design System into your project is quite simple.
                            </p>
                            <p>
                                Once imported, you can use Vira Design System's mixins, variables, and functions right in your
                                project.
                            </p>
                            <CodeBlock
                                code={`// main.scss
@use "node_modules/vds-ui/vds-core" as *; // Core build OR
@use "node_modules/vds-ui/src/vds-ext" as *; // Extended build
    ...
    .my-class {
        background-color: rgba(#{hex-to-rgb(fill('blue', '600'))}, .25);
                        ...
                        <section className="padtop" id="customize">
                            ...
                            <p>
                                Vira Design System is a framework that is designed to be customized. At its core is a powerful
