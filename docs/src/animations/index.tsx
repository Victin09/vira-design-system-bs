                ...
                <section className="padtop" id="animations">
                    <div className="content">
                        ...
                        <p>
                            ...
                            are also alive. Vira Design System comes bundled with animated components to help you get started.
                        </p>
                    </div>
                </section>
                ...
                <section className="padtop" id="spinner">
                    <div className="content">
                        ...
                        <p>
                            ...
                            <code>animated loading</code> selectors to the element and Vira Design System will handle the rest.
                        </p>
                        <p>
            ...
            <div><b>3 new unopened messages in the last hour.</b>
                ...
                <section className="padtop" id="animation-utils">
                    <div className="content">
                        ...
                        <div className="divider"></div>
                        <p>
                            Vira Design System comes with a couple of tools you can use to help test or modify animation behavior.
                        </p>
                        <div className="space"></div>
