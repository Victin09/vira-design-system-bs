            ...
            <span>
                <section className="padtop" id="columns">
                    <div className="content">
                        ...
                        <p>
                            Classes for using Vira Design System' column system powered by Flexbox. By default, 12 columns are
        ...
        <div class="uppercase">col-10</div>
                ...
                <section className="padtop" id="viewports">
                    <div className="content">
                        ...
                        <p>
                            In Vira Design System, columns have 4 different variants based on breakpoints: <code>xs</code>,{' '}
                        ...
                        <p>
                            ...
                            the column, where '*' indicates any number from 1 to 12 (or however many columns you configured your Vira Design System build with).
                        </p>

                        <p className="title">Before</p>
                        <LazyLoad height={200}>
                            <iframe
                                src="https://spiderpig86.github.io/Vira Design System/0.6.0/docs/layout/width-ignore-before.html"
                        ...
                        <LazyLoad height={200}>
                            <iframe
                                src="https://spiderpig86.github.io/Vira Design System/0.6.0/docs/layout/width-ignore-after.html"
                                style={{ height: '250px', width: '100%', maxWidth: '700px' }}
                                className="w-100p p-1"
                            />
                        </LazyLoad>
