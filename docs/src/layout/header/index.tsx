...
export const HeaderPage: React.FC<any> = (props) => {
            ...
            <div>
                <section className="padtop" id="header">
                    <div className="content">
                        ...
                        <p>
                            Vira Design System makes designing the perfect header extremely simple. It is designed to be as flexible
                    ...
                    <div className="content">
                        ...
                        <LazyLoad height={200}>
                            <iframe
                                className="w-100p"
                                title="Header Demo"
                                src="https://spiderpig86.github.io/Vira Design System/0.6.0/docs/header/demo-head.html"
                            />
                        </LazyLoad>
                        <div className="space"></div>
                        <CodeBlock
    ...
    <div class="header-brand">
        <!-- Insert other nav-items -->
                        ...
                        <LazyLoad height={200}>
                            <iframe
                                src="https://spiderpig86.github.io/Vira Design System/0.6.0/docs/header/demo-header-brand.html"
                                width="100%"
                                title="Header Brand"
                                style={{ height: '200px' }}
                            />
                ...
                <section className="padtop" id="button">
                    <div className="content">
                        ...
                        <LazyLoad height={200}>
                            <iframe
                                src="https://spiderpig86.github.io/Vira Design System/0.6.0/docs/header/demo-header-btn.html"
                                width="100%"
                                title="Header Button"
                                style={{ height: '200px' }}
                            />
    ...
    <div class="nav-item nav-btn" style="cursor: pointer; display: block; position: relative; margin-left: auto;">
        ...
        <span></span>
                        ...
                        <LazyLoad height={200}>
                            <iframe
                                src="https://spiderpig86.github.io/Vira Design System/0.6.0/docs/header/demo-header-btn-close.html"
                                width="100%"
                ...
                <section className="padtop" id="nav">
                    <div className="content">
                        ...
                        <LazyLoad height={200}>
                            <iframe
                                src="https://spiderpig86.github.io/Vira Design System/0.6.0/docs/header/demo-header-nav.html"
                                width="100%"
                                title="Header Nav"
                                style={{ height: '200px' }}
                            />
    ...
    <div class="header-nav" style="background-color: #ffdadd;" id="header-menu">
        <!-- Other nav categories, controls, nav-items, etc. This is hidden on touch enabled devices -->
                        ...
                        <p>
                            ...
                            larger than <code>768px</code>, Vira Design System provides different layouts to place elements within
                        ...
                        <p>
                            Keep in mind that the script used to toggle the menus is not included in Vira Design System and it is
                            best to develop a custom one that fits your site. Below is a sample of what can fit in any
                            site running Vira Design System.
                        </p>
...
$('.dropdown-menu li').on('click', function(e) {
     ...
     $('.nav-btn').removeClass('active');
                ...
                <section className="padtop" id="regions">
                    <div className="content">
                        ...
                        <LazyLoad height={200}>
                            <iframe
                                src="https://spiderpig86.github.io/Vira Design System/0.6.0/docs/header/demo-head-dist-1.html"
                                width="100%"
                        ...
                        <LazyLoad height={200}>
                            <iframe
                                src="https://spiderpig86.github.io/Vira Design System/0.6.0/docs/header/demo-head-dist-2.html"
                                width="100%"
                        ...
                        <LazyLoad height={200}>
                            <iframe
                                src="https://spiderpig86.github.io/Vira Design System/0.6.0/docs/header/demo-head-dist-3.html"
                                width="100%"
                        ...
                        <LazyLoad height={200}>
                            <iframe
                                src="https://spiderpig86.github.io/Vira Design System/0.6.0/docs/header/demo-head-left.html"
                                width="100%"
                        ...
                        <LazyLoad height={200}>
                            <iframe
                                src="https://spiderpig86.github.io/Vira Design System/0.6.0/docs/header/demo-head-center.html"
                                width="100%"
                        ...
                        <LazyLoad height={200}>
                            <iframe
                                src="https://spiderpig86.github.io/Vira Design System/0.6.0/docs/header/demo-head-right.html"
                                width="100%"
    ...
    <button class="btn-accent">World</button>
                        ...
                        <LazyLoad height={200}>
                            <iframe
                                src="https://spiderpig86.github.io/Vira Design System/0.6.0/docs/header/demo-dropdown-content.html"
                                title="Header Dropdown Content"
                                width="100%"
                            />
                        </LazyLoad>
                        <p>
                            Vira Design System provides flexibility for which type of elements you can use for your{' '}
                        ...
                        <LazyLoad height={200}>
                            <iframe
                                src="https://spiderpig86.github.io/Vira Design System/0.6.0/docs/header/demo-navitem-states.html"
                                width="100%"
    ...
    Docs</a>
                        ...
                        <LazyLoad height={200}>
                            <iframe
                                src="https://spiderpig86.github.io/Vira Design System/0.6.0/docs/header/demo-dropdown.html"
    ...
    $(this).toggleClass('active'); // Toggle the active selector on the nav-item
                        ...
                        <p>
                            If <b>JavaScript</b> is not an option in showing the menu, Vira Design System now provides a hover
                        ...
                        <LazyLoad height={200}>
                            <iframe
                                src="https://spiderpig86.github.io/Vira Design System/0.6.0/docs/header/demo-dropdown-hover.html"
                                width="100%"
    ...
    <ul class="dropdown-menu dropdown-animated" role="menu">
        ...
        <li role="menu-item"><a>Log Out</a></li>
                        ...
                        <p>
                            ...
                            Vira Design System will automatically align and position them depending if it is inside a{' '}
                        ...
                        <LazyLoad height={200}>
                            <iframe
                                src="https://spiderpig86.github.io/Vira Design System/0.6.0/docs/header/demo-dropdown-align.html"
...
<hr class="dropdown-menu-divider"></div>`}
                        ...
                        <LazyLoad height={200}>
                            <iframe
                                src="https://spiderpig86.github.io/Vira Design System/0.6.0/docs/header/demo-dropdown-divider.html"
                ...
                <section className="padtop" id="static">
                    <div className="content">
                        ...
                        <div className="divider"></div>
                        <p>
                            By default, headers in Vira Design System are not fixed to the top of the screen, but to the top of the
                        ...
                        <LazyLoad height={200}>
                            <iframe
                                src="https://spiderpig86.github.io/Vira Design System/0.6.0/docs/header/demo-head-nofix.html"
                        ...
                        <LazyLoad height={200}>
                            <iframe
                                src="https://spiderpig86.github.io/Vira Design System/0.6.0/docs/header/demo-head-fix.html"
                ...
                <section className="padtop" id="themes">
                    <div className="content">
                        ...
                        <div className="divider"></div>
                        <p>
                            When it comes to header themes, Vira Design System's design language also applies to this component.
                        ...
                        <LazyLoad height={200}>
                            <iframe
                                src="https://spiderpig86.github.io/Vira Design System/0.6.0/docs/header/demo-head-dark.html"
                        ...
                        <LazyLoad height={200}>
                            <iframe
                                src="https://spiderpig86.github.io/Vira Design System/0.6.0/docs/header/demo-head-clear.html"
