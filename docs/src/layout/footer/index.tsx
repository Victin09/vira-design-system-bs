            ...
            <div>
                <section className="padtop" id="footer">
                    <div className="content">
                        ...
                        <p>
                            Vira Design System provides a styling for your footer using the <code>footer</code> class.
                        </p>
                    </div>
                </section>
                    ...
                    <div className="content">
                        ...
                        <ul>
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    be used in combination with Vira Design System's columns to create a clean site map.
                                </li>
                            </ul>
                        </ul>
                        ...
                        <LazyLoad height={200}>
                            <iframe
                                className="w-100p"
                                title="Footer Demo"
                                src="https://spiderpig86.github.io/Vira Design System/0.6.0/docs/footer/demo-footer.html"
                            />
                        </LazyLoad>
                        <div className="space"></div>
                        <CodeBlock
                    ...
                    <div className="content">
                        ...
                        <LazyLoad height="200">
                            <iframe
                                className="w-100p"
                                title="Static Footer"
                                src="https://spiderpig86.github.io/Vira Design System/0.6.0/docs/footer/demo-footer-static.html"
                            />
                        </LazyLoad>
                        <div className="space"></div>
                        <CodeBlock
                    ...
                    <div className="content">
                        ...
                        <LazyLoad height="200">
                            <iframe
                                ...
                                src="https://spiderpig86.github.io/Vira Design System/0.6.0/docs/footer/demo-footer-flexible.html"
                            />
                        </LazyLoad>
    ...
    background: linear-gradient(rgba(0,0,0,.5),rgba(0,0,0,.5)),url(https://images.unsplash.com/photo-1514227765494-1bbd6ba05916?auto=format&fit=crop&w=1600&q=100) no-repeat;
                        ...
                        <LazyLoad height="200">
                            <iframe
                                ...
                                src="https://spiderpig86.github.io/Vira Design System/0.6.0/docs/footer/demo-footer-minimal.html"
                            />
                        </LazyLoad>
                        <div className="space space--lg"></div>
                        ...
                        <LazyLoad height="200">
                            <iframe
                                className="w-100p"
                                title="Footer Map"
                                src="https://spiderpig86.github.io/Vira Design System/0.6.0/docs/footer/demo-footer-map.html"
                            />
                        </LazyLoad>
                        <div className="space space--lg"></div>
                        ...
                        <LazyLoad height="200">
                            <iframe
                                ...
                                src="https://spiderpig86.github.io/Vira Design System/0.6.0/docs/footer/demo-footer-newsletter.html"
                            />
                        </LazyLoad>
                        <div className="space space--lg"></div>
                        ...
                        <LazyLoad height="200">
                            <iframe
                                className="w-100p"
                                title="Social Footer"
                                src="https://spiderpig86.github.io/Vira Design System/0.6.0/docs/footer/demo-footer-social.html"
                            />
                        </LazyLoad>
                        <div className="space space--lg"></div>
