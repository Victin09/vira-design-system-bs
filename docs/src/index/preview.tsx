            ...
            <section id="colors" className="padtop">
                <div className="content">
                    <div className="u-text-center content">
                        ...
                        <p className="lead">
                            Choose from a number of vibrant colors from Vira Design System's palette to make your website <b>pop</b>
                            .
                        </p>
                    </div>
            ...
            <section id="typography" className="padtop">
                <div className="content">
                    <div className="u-text-center content">
                        ...
                        <p className="lead">
                            Vira Design System primarily uses{' '}
            ...
            <section id="layouts" className="padtop">
                <div className="content">
                    <div className="u-text-center content">
                        ...
                        <p className="lead">
                            Vira Design System makes creating layouts easy with <b>flexbox</b> and <b>grid</b> support.
                        </p>
                    </div>
                    <div className="space space--xl" />
            ...
            <section className="padtop" id="additional">
                <div className="content">
                    <div className="u-text-center content">
                        ...
                        <p className="lead">
                            See all that Vira Design System has to offer. Below are some additional useful components.
                        </p>
                    </div>
                    <div className="r">
