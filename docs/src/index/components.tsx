        ...
        <div className="bg-white u-round-sm u-shadow-sm p-3 text-center">
            ...
            <div className="avatar-container u-flex u-justify-center u-items-center mb-2">
                {[11, 12, 13, 14].map((img) => (
                    ...
                    >
                        <img
                            src={`https://raw.githubusercontent.com/Spiderpig86/Vira Design System/gh-pages/vds-docs-next/static/img/avatars/${img}.jpg`}
                            alt="avatar"
                        />
                    </div>
                ))}
                ...
                >
                    ...
                    <img
                        src="https://raw.githubusercontent.com/Spiderpig86/Vira Design System/gh-pages/vds-docs-next/static/img/avatars/15.jpg"
                        alt="avatar"
                    />
                </div>
            </div>
...
export const LoginCard: React.FC<any> = (props) => {
    return (
        <div className="bg-black u-round-sm u-shadow-sm p-3 u-text-center">
            <h6 className="text-white tracking-tight my-0">Sign in to Vira Design System</h6>
        ...
        <div className="bg-gray u-round-sm u-shadow-sm p-3 u-text-center">
            <div className="u-flex u-gap-2 u-center">
                <div className="avatar">
                    <img src="https://raw.githubusercontent.com/Spiderpig86/Vira Design System/gh-pages/vds-docs-next/static/img/avatars/12.jpg" />
                </div>
