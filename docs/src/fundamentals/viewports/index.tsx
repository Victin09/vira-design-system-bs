            ...
            <div>
                <section className="padtop" id="viewports">
                    <div className="content">
                        ...
                        <p>
                            Vira Design System by default is a framework designed to make developing mobile optimized sites easier.
                ...
                <section className="padtop" id="breakpoints">
                    <div className="content">
                        ...
                        <p>
                            The standard breakpoints used in Vira Design System are <code>xs</code>, <code>sm</code>,{' '}
                        ...
                        <p>From that, the class designations in Vira Design System follow this guideline:</p>
                        <TableWrapper>
                            <table className="table bordered">
                                <thead>
                                    <tr>
                ...
                <section className="padtop" id="customization">
                    <div className="content">
                        ...
                        <p>
                            ...
                            configuration when importing Vira Design System.
                        </p>
                        <div className="space"></div>
