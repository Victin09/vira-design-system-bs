            ...
            <div>
                <section className="padtop" id="default-styles">
                    <div className="content">
                        ...
                        <p>
                            The base of Vira Design System's styling is a simple CSS reset that ensures every page will start off
                            with a clean slate before other styles are applied. Think of it as Vira Design System erasing the chalk
                ...
                <section className="padtop" id="reset">
                    <div className="content">
                        ...
                        <p>
                            The reset styles from Vira Design System have been carefully chosen to create the environment that is
                            best for Vira Design System to work with. The choices are somewat subjective and should be modified to fit your own requirements.
                        </p>
...
/* Selection Color */
::selection {
    background-color: var(--vds-select-bg);
}

/* When focusing any element */
:focus {
    box-shadow: var(--vds-focus-size) var(--vds-focus-color);
    outline: none;
}
        ...
        scroll-behavior: auto !important;
                ...
                <section className="padtop" id="disabling">
                    <div className="content">
                        ...
                        <CodeBlock code={`@use "node_modules/vds-ui/src/vds-ext" as * with (
    $config: (
        excludes: (
            'RESET'
        )
