            ...
            <div>
                <section className="padtop" id="colors">
                    <div className="content">
                        ...
                        <p>
                            Vira Design System comes with a semantic palette and an expanded palette to help you style your page.
                ...
                <section className="padtop" id="classes">
                    <div className="content">
                        ...
                        <div className="divider"></div>
                        <p>
                            Using a color within Vira Design System is as simple as just prefixing the colors with <code>bg-</code>{' '}
    ...
    Custom Button
                ...
                <section className="padtop" id="v2">
                    <div className="content">
                        ...
                        <p>
                            Vira Design System has an extensive color palette that has been updated with <b>0.6.0</b> to make them
...
<p class="u-color-opacity-0 ...">The quick brown fox jumps over the lazy dog.</p>`} language='htmlbars' />
                ...
                <section className="padtop" id="extending-colors">
                    <div className="content">
                        ...
                        <p>
                            If you want additional colors on top of the ones shipped with Vira Design System, you can extend the
...
.text-blue-500 { color: #fff !important; }`}
                ...
                <section className="padtop" id="disabling-colors">
                    <div className="content">
                        ...
                        <p>If you would like to remove a default color, you can simply set any of the color maps of the extended palette to <code>null</code>. Vira Design System will not generate any of these colors in the final build.</p>
                        <CodeBlock
                            code={`@use "node_modules/vds-ui/src/vds-ext" as * with (
    $config: (
        colors: (
