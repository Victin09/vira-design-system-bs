            ...
            <div>
                <section className="padtop" id="sizing-system">
                    <div className="content">
                        ...
                        <p>
                            Certain classes in Vira Design System follow a framework-wide sizing system that makes finding the
                ...
                <section className="padtop" id="sizes">
                    <div className="content">
                        ...
                        <p>As a reference, the default sizing system in Vira Design System is shown below.</p>
