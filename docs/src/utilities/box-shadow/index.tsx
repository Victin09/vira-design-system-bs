...
export const BoxShadowUtilsPage: React.FC<any> = (props) => {
    const DEFAULT_BOX_SHADOW_CLASSES = {
        none: '--vds-shadow: 0 0 #000;',
        xs: '--vds-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);',
        sm: '--vds-shadow: (0 1px 3px 0 rgba(0, 0, 0, 0.1), 0 1px 2px 0 rgba(0, 0, 0, 0.06));',
        md: '--vds-shadow: (0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06));',
        lg: '--vds-shadow: (0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05));',
        xl: '--vds-shadow: (0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04));',
        inset: '--vds-shadow: inset 0 2px 4px 0 rgba(0, 0, 0, 0.06);',
    };
                ...
                <section className="padtop" id="variants">
                    <div className="content">
                        ...
                        <p>
                            ...
                            add, change, or remove classes within the <code>_config.scss</code> file of Vira Design System.
                        </p>
...
$config: (
    extend: (
        shadows: (
            '2xl': (
                --vds-shadow: (0 25px 30px -10px rgba(0, 0, 0, 0.1),
    ...
    box-shadow: var(--vds-shadow);
                        ...
                        />
                        <p>
                            Learn more about how to extend Vira Design System to support your use cases in the{' '}
