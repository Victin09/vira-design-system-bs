            ...
            <div>
                ...
                <section className="padtop" id="examples">
                    <div className="content">
                        ...
                        <p>
                            Vira Design System comes with utility classes that allow you to anchor any element in any of the 4
                ...
                <section className="padtop" id="responsive">
                    <div className="content">
                        ...
                        <Blockquote accentColor={'#fcd9bd'}>
                            <p>
                                ⚠ Note that the viewport variants are disabled in the default build of Vira Design System. To
