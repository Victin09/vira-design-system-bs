            ...
            <div>
                <section id="whats-new" className="padtop">
                    <div className="content">
                        ...
                        <p>
                            Like Vira Design System 0.6.0, 0.7.0 was another large undertaking that brought a large refactor of the
                            entire codebase to prioritize configurability and enhance overall developer experience. This
                            rewrite represents the first step in how Vira Design System is repositioning as a
                ...
                <section className="padtop" id="new-way">
                    <div className="content">
                        <Headline size="4" title="A new way to use Vira Design System" link="#new-way" />
                        <div className="divider"></div>
                        <p>
                            With previous versions, the only ways to use Vira Design System was to either{' '}
                            <strong>linking the CDN link</strong> at the top of your page or{' '}
                            <strong>
                                importing <code>vds-ui</code>
                            </strong>{' '}
                            into your Node project.
                        </p>
                        <p>
                            This is fine, but it lacked any sort of customization. The only way to change Vira Design System was to
                            clone the project and build your own version locally. Dart Sass has given me immense
                            opportunity to improve Vira Design System&#39;s usability and fix technical debt and hacks. One of the
                            things it also enabled was directly importing Vira Design System into your Sass/Scss project directly.
                        </p>
                        <p>
                            <strong>
                                Not only can you import different pre-configured versions of Vira Design System, but also take
                                advantage of all the functions, mixins, constants, etc. that Vira Design System comes built with.
                            </strong>
                        </p>
...
@screen-above($md) {
    .my-class {
        background-color: rgba(#{hex-to-rgb(fill('blue', '600'))}, .25);
                        ...
                        <p>
                            No more having to build Vira Design System separately and then copying and pasting the generated styles
                ...
                <section className="padtop" id="configurability">
                    <div className="content">
                        ...
                        <p>
                            0.7.0 marks a big step in dynamic class generation. Whether you are building Vira Design System locally
                            or you&#39;re importing Vira Design System directly into your Sass files, you can take advantage of
            ...
            opacity: (
                ...
                <section className="padtop" id="utils">
                    <div className="content">
                        ...
                        <div className="divider"></div>
                        <p>
                            Utility classes within Vira Design System have grown to be quite popular. This update adds utility
                            classes for:
                        </p>
                        <ul>
                            <li>
                ...
                <section className="padtop" id="components">
                    <div className="content">
                        ...
                        <ul>
                            ...
                            <li>
                                <InternalLink url="/elements/progress">Progress</InternalLink> — Vira Design System comes with
