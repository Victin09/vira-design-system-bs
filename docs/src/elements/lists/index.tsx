...
export const ListsPage: React.FC<any> = (props) => {
            ...
            <div>
                <section className="padtop" id="lists">
                    <div className="content">
                        ...
                        <p>
                            Besides basic styling for lists, Vira Design System also ships with classes that allow lists to be
    ...
    <dd>
        ...
        Cupertino, California that designs, develops, and sells consumer electronics, ...
                        ...
                        <h6>Nested Lists</h6>
                        <p>
                            Vira Design System will automatically style and pad nested lists so you don't have to. Just add the{' '}
            ...
            <li>
                ...
                <section className="padtop" id="menus">
                    <div className="content">
                        ...
                        <p>
                            ...
                            Vira Design System components or used standalone.
                        </p>
                        <p>
                ...
                <section className="padtop" id="dropdown">
                    <div className="content">
                        ...
                        <p>
                            Drop down menus are easy to configure in Vira Design System using lists. Simply wrap the button and the
                            menu in a <code>list-dropdown</code> container and Vira Design System will automatically style all the
