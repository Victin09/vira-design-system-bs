...
export const CardsPage: React.FC<any> = (props) => {
    ...
    <div class="card__footer content">2 min. read 22 comments</div>
                ...
                <section className="padtop" id="grouping">
                    <div className="content">
                        ...
                        <p>
                            Cards can be grouped using Vira Design System's{' '}
    ...
    <div class="content">
        <p>This is some sample text spam spam spam spam spam spam spam. <a href="!#">#place</a><a href="!#">#holder</a><a href="!#">@Vira Design System</a></p>
    </div>
