            ...
            <span>
                <section className="padtop" id="text-elements">
                    <div className="content">
                        ...
                        <p>Here is how Vira Design System styles other text elements in the framework.</p>
                    </div>
                </section>
                ...
                <section className="padtop" id="blockquotes">
                    <div className="content">
                        ...
                        <blockquote>
                            <p>
                                You know, I think Vira Design System is a pretty good CSS framework. - <em>Marc Andreessen</em>
                            </p>
                        </blockquote>
                    </div>
                </section>
