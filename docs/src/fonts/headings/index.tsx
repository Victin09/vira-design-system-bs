            ...
            <span>
                ...
                <section className="padtop" id="examples">
                    <div className="content">
                        ...
                        <p>
                            Vira Design System styles the standard header tags <code>h1, h2, h3, h4, h5, h6</code> with font sizes
                            ranging from <code>4rem</code> to <code>1rem</code> where each <code>rem</code> is{' '}
                            <code>16px</code>. Vira Design System allows you to choose between two fonts: <code>Montserrat</code>{' '}
                ...
                <section className="padtop" id="variants">
                    <div className="content">
                        ...
                        <p>
                            ...
                            You can add, change, or remove classes within the <code>_config.scss</code> file of Vira Design System.
                        </p>
