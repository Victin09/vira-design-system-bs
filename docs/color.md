...
Brand colors are used when refering to Vira or any of its products.
...
<div class="box is-large is-popping has-background-info-gradient">
    ...
    <p class="subtitle is-5 has-text-dark">Paint your Slack to the colors of Vira by copy-pasting the below HEX codes into your Slack preferences.</p>
