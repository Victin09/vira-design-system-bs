...
<p class="vds-text-lead">Upload files through a file input form element or a placeholder area.</p>
...
```example
<div class="js-upload" vds-form-custom>
...
```example
<div class="js-upload vds-placeholder vds-text-center">
    <span vds-icon="icon: cloud-upload"></span>
    <span class="vds-text-middle">Attach binaries by dropping them here or</span>
    <div vds-form-custom>
        <input type="file" multiple>
        <span class="vds-link">selecting one</span>
    </div>
</div>

<progress id="js-progressbar" class="vds-progress" value="0" max="100" hidden></progress>

<script>

    var bar = document.getElementById('js-progressbar');

    ViraDesignSystem.upload('.js-upload', {
...
| `cls-dragover`     | String   | `vds-dragover`           | File name filter.                                                                                          |
...
```js
ViraDesignSystem.upload(element, options);
```
