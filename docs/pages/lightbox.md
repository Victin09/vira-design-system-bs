...
<p class="vds-text-lead">Create a responsive lightbox gallery with images and videos.</p>
...
To apply this component, add the `vds-lightbox` attribute to a container to turn all anchors inside that container into lightbox links.
...
```example
<div vds-lightbox>
    <a class="vds-button vds-button-default" href="images/photo.jpg">Open Lightbox</a>
</div>
```
...
```example
<div vds-lightbox>
    <a class="vds-button vds-button-default" href="images/photo.jpg" data-alt="Image">Open Lightbox</a>
</div>
```
...
```example
<div vds-lightbox>
    <a class="vds-button vds-button-default" href="images/photo.jpg" data-caption="Caption">Open Lightbox</a>
</div>
```
...
```html
<div vds-lightbox="animation: fade">
    <a href="image.jpg"></a>
</div>
```
...
<div class="vds-child-width-1-3@m" vds-grid vds-lightbox="animation: slide">
    <div>
        <a class="vds-inline" href="images/photo.jpg" data-caption="Caption 1">
            <img src="images/photo.jpg" width="1800" height="1200" alt="">
        </a>
    </div>
    <div>
        <a class="vds-inline" href="images/dark.jpg" data-caption="Caption 2">
            <img src="images/dark.jpg" width="1800" height="1200" alt="">
        </a>
    </div>
    <div>
        <a class="vds-inline" href="images/light.jpg" data-caption="Caption 3">
...
<div class="vds-child-width-1-3@m" vds-grid vds-lightbox="animation: fade">
    <div>
        <a class="vds-inline" href="images/photo.jpg" data-caption="Caption 1">
            <img src="images/photo.jpg" width="1800" height="1200" alt="">
        </a>
...
<div class="vds-child-width-1-3@m" vds-grid vds-lightbox="animation: scale">
    <div>
        <a class="vds-inline" href="images/photo.jpg" data-caption="Caption 1">
            <img src="images/photo.jpg" width="1800" height="1200" alt="">
        </a>
...
```html
<div vds-lightbox>
    <a class="vds-button" href="video.mp4" data-poster="image.jpg"></a>
    <a class="vds-button" href="https://www.youtube.com/watch?v=c2pz2mlSfXA"></a>
    <a class="vds-button" href="https://vimeo.com/1084537"></a>
    <a class="vds-button" href="https://www.google.com/maps"></a>
</div>
```

```example
<div vds-lightbox>
    <a class="vds-button vds-button-default" href="images/photo.jpg" data-caption="Image">Image</a>
    <a class="vds-button vds-button-default" href="https://yootheme.com/site/images/media/yootheme-pro.mp4" data-caption="Video">Video</a>
    <a class="vds-button vds-button-default" href="https://www.youtube.com/watch?v=c2pz2mlSfXA" data-caption="YouTube">YouTube</a>
    <a class="vds-button vds-button-default" href="https://vimeo.com/1084537" data-caption="Vimeo">Vimeo</a>
    <a class="vds-button vds-button-default" href="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4740.819266853735!2d9.99008871708242!3d53.550454675412404!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x3f9d24afe84a0263!2sRathaus!5e0!3m2!1sde!2sde!4v1499675200938" data-caption="Google Maps" data-type="iframe">Google Maps</a>
</div>
```
...
```html
<div vds-lightbox>
    <a class="vds-button" href="https://www.youtube.com/watch?v=c2pz2mlSfXA" data-attrs="width: 1280; height: 720;"></a>
</div>
```

```example
<div vds-lightbox>
    <a class="vds-button vds-button-default" href="https://www.youtube.com/watch?v=c2pz2mlSfXA" data-caption="YouTube" data-attrs="width: 1280; height: 720;">YouTube</a>
</div>
```
...
ViraDesignSystem.lightbox(element, options);

// To dynamically initialize the lightbox panel
ViraDesignSystem.lightboxPanel(panelOptions);
```
...
```js
ViraDesignSystem.lightbox(element).show(index);
```
...
```js
ViraDesignSystem.lightbox(element).hide();
```
...
```js
ViraDesignSystem.lightboxPanel(element).show(index);
```
...
```js
ViraDesignSystem.lightboxPanel(element).hide();
```
...
```js
ViraDesignSystem.lightboxPanel(element).startAutoplay();
```
...
```js
ViraDesignSystem.lightboxPanel(element).stopAutoplay();
```
