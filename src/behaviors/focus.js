...
export default class FocusBehavior extends Behavior {
  constructor(host, options) {
    ...
    const transferChild = host.constructor.vdsContents;
  ...
  setEffect(bool) {
    this.host.vdsSetMod('focus', bool);
    this.host.vdsSetContext('focus', bool || null);
  ...
  set(param) {
    ...
    this.host.vdsSetMod('focusable', param || null);
  }
}
