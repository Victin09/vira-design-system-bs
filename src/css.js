...
// [...document.querySelectorAll('style[data-vds-name]')]
//   .forEach(element => {
...
`:root:not([data-vds-prevent-reset]) body {
  line-height: 1rem;
}`,

`:root:not([data-vds-prevent-reset]) body > *:not([size]) {
  line-height: 1.5rem;
}`,

`.vds-defaults, :root:not([data-vds-prevent-reset]) body {
  margin: 0;
  padding: 0;
...
`.vds-defaults:not(body) {
  line-height: 1.5rem;
}`,

`@media (prefers-color-scheme: dark) {
  :root:not([data-vds-scheme="light"]) .vds-dark-invert {
    filter: invert(100%) hue-rotate(180deg);
  }
}`,

`@media (prefers-color-scheme: dark) {
  :root:not([data-vds-scheme="light"]) .vds-dark-dim, :root:not([data-vds-scheme="light"]) vds-img {
    filter: brightness(0.95);
  }
}`,

`:root[data-vds-scheme="dark"] .vds-dark-invert {
  filter: invert(95%) hue-rotate(180deg);
}`,

`:root[data-vds-scheme="dark"] .vds-dark-dim, :root[data-vds-scheme="dark"] vds-img {
  filter: brightness(0.95);
}`,
...
`:root[data-vds-reduce-motion] {
  --transition-enabler: 0;
}`,

`:root[data-vds-outline] [vds], :root[data-vds-outline] [vds-contents] > * {
  outline: var(--border-width, 1px) solid var(--outline-color) !important;
}`,

`:root:not([data-vds-outline]) [vds], :root:not([data-vds-outline]) [vds-contents] > * {
